pipeline {
  environment {
    DOCKERHUB_IMAGE_NAME = 'datoma/netatmo-exporter'
    ARTIFACTORY_IMAGE_NAME = 'datoma.jfrog.io/docker-local/netatmo-exporter'
    dockerHubImageLatest = ''
    dockerHubImagetag = ''
    artifactoryImageLatest = ''
    artifactoryImageTag = ''
    
    GIT_URL = 'git@github.com:datoma/netatmo-exporter.git'
    GIT_BRANCH = 'master'
